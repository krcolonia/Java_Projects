...
public class MatrixA {
	...
	public static void rangeOfRowsAndColumns() {
		if(rowRange < 2 && colRange < 2) {
			System.out.println("\nMatrix A has " + rowRange + " Row and " + colRange + " Column\n");
		}
		else if(rowRange >= 2 && colRange < 2) {
			System.out.println("\nMatrix A has " + rowRange + " Rows and " + colRange + " Column\n");
		}
		else if(rowRange < 2 && colRange >=2) {
			System.out.println("\nMatrix A has " + rowRange + " Row and " + colRange + " Columns\n");
		}
		else {
			System.out.println("\nMatrix A has " + rowRange + " Rows and " + colRange + " Columns\n");
		}
	}
